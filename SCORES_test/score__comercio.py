...
df_train_0 = pd.read_excel(path_1[:-13] + '/Data/df_test_0.xlsx', index_col = 'id')
tabla_3 = df_train_0[['latitud', 'longitud']].copy()

# RELACIONA BASE DE SS CON COORDENADAS
tabla_1 = pd.read_excel(path_1[:-13] + '/Data/df_coodenadas_supersociedades.xlsx', index_col= 'Codigo Instancia')
tabla_1.drop([tabla_1.columns[0]], axis = 1, inplace = True)

# RELACIONA BASE DE SS
tabla_2 = pd.read_excel(path_1[:-13] + '/Supersociedades/base_supersociedades_seg.xlsx', index_col= 'Codigo Instancia')
...
tabla_4 = pd.read_excel(path_1[:-13] + '/Supersociedades/CIIU.xlsx')
...
tabla_3.to_excel(path_1[:-13] + '/Data/scores_test/score_comercio_600mm.xlsx')
