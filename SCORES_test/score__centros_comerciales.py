...
'''
tabla_1 = pd.read_excel(path_0[:-12] + '/Data/df_centros_comerciales.xlsx')
tabla_1 = tabla_1[["cc", "lat", "lon"]]

# SE LLAMA LA BASE df_train_0
df_train_0 = pd.read_excel(path_0[:-12] + '/Data/df_test_0.xlsx', index_col=('id'))
...
df_train_0.to_excel(path_0[:-12] + '/Data/scores_test/score_centro_comercial.xlsx')
