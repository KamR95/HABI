...
tabla_1 = pd.read_excel(path_0[:-13] + '/Data/estaciones.xlsx', index_col = 0 )
...
for i in range(0, tabla_3.shape[0]):
    ...
    score_ = lc.Score_estaciones(lat_, lon_, tabla_1, 0.5)
    score_.get_score()
...
tabla_3.to_excel(path_0[:-13] + '/data/scores_test/score_estaciones.xlsx')